...
public class LocationService extends Service {
   /*************************************************/
    ...
    private static String ToastSettingMessage = "Lütfen Konumu Açın";
    ...
    private class Network implements LocationListener {
        ...
        public void onProviderEnabled(String provider) {
            ...
            locationManagerNetwork.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, TimeLoc, Distance, this);
            if (!wifi.isWifiEnabled() && WifiStatus) {
                wifi.setWifiEnabled(true);
            }
        }
    ...
    public static void setIsOpenSettingActivity(boolean OpenSettingActivity) {
    ...
    public static void StopService() {
        ...
        network = null;
        locationGPS = null;
        locationNETWROK = null;
        listenerLocation = null;
        ToastSettingMessage = null;
    }
